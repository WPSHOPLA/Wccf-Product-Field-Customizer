        ...
        try {
            ...
            switch ($action) {
                ...
                case 'duplicate':
                    ...
                    $is_new_post = RightPress_Help::post_status_is($this->get_id(), 'draft');
                    ...
                    foreach ($this->get_meta_properties() as $key => $type) {
                        ...
                        if (method_exists($this, 'sanitize_' . $key . '_value')) {
                            ...
                            $value = isset($data[$key]) ? $data[$key] : RightPress_Help::get_empty_value_by_type($type);
                        }
    ...
    public function update_field($field, $value)
    {
        ...
        if (!$this->update_own_field($field, $value)) {
            ...
            if (array_key_exists($field, $meta_properties)) {
                $this->$field = $value !== null ? RightPress_Help::cast_to($meta_properties[$field], $value) : null;
