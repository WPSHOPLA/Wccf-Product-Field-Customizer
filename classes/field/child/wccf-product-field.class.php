...
class WCCF_Product_Field extends WCCF_Field
{
    ...
    {
        return RightPress_WC::order_item_meta_exists($item, $key);
    }
    ...
    {
        return RightPress_WC::order_item_get_meta($item, $key, $single);
    }
    ...
    {
        RightPress_WC::order_item_add_meta_data($item, $key, $value, $unique);
    }
    ...
    {
        RightPress_WC::order_item_update_meta_data($item, $key, $value);
    }
    ...
    {
        RightPress_WC::order_item_delete_meta_data($item, $key);
    }
    ...
    {
        return is_object($item) ? $item : RightPress_Help::wc_get_order_item($item);
    }
